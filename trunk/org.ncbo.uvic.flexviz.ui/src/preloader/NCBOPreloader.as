package preloader
{
	 ...
	 */
    public class NCBOPreloader extends Sprite implements IPreloaderDisplay
    {
    	
    	[Embed("assets/preloader_logo.png")]
        [Bindable] 
        ...
        private var simpleBarWidth:Number = 150;
        private var simpleBarHeight:Number = 15;
        
        private var loading:String = "Loading ";
        
        public var simple:Boolean = false;
        
        public function NCBOPreloader() {
            super();
        }
        ...
        private function checkSimpleFlag():void {
            ...
            if (loaderInfo && loaderInfo.parameters && (loaderInfo.parameters["simplepreloader"] == "true")) {
            	simple = true;
            }
            if (simple) {
